...
<div class="content">
        <div class="py-4 px-3 px-md-4">
            ...
            <div class="mb-3 mb-md-4 d-flex justify-content-between">
                <div class="h3 mb-0">Nos voitures en locations</div>
            </div>
            <div class="row">
                @foreach($vehicule as $vehicule)
                    @if($vehicule->location_effectuee==0)
                        <div class="col-md-6 col-xl-4 mb-3 mb-md-4">
                            ...
                            <div class="card h-70">
                                ...
                                <div class="card-body p-0">
                                    ...
                                    <div class="">
                                        <img  height="200" width="350" src="{{ asset('photos/' . $vehicule->photo) }}">
                                    </div>
                                    <a type="submit" class="btn btn-toolbar" href="{{route('vehicule.details', ['id' => $vehicule->id]) }}">Voir détails</a>
                                </div>
                            </div>
                            <!-- End Card -->
                        </div>
