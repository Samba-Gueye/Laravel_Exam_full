                        ...
                        <form action="{{route('location.store')}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-row">
                                <div class="form-group col-12 col-md-4">
                                    ...
                                    <input type="text" class="form-control" value="" id="lieu_depart" name="lieu_depart" placeholder="Lieu de départ">
                                </div>

                                <div class="form-group col-12 col-md-4">
                                    <label for="name">Lieu d'arrivé</label>
                                    <input type="text" class="form-control" value="" id="lieu_arrivé" name="lieu_arrive" placeholder="Lieu d'arrivé">
                                </div>

                                <div class="form-group col-12 col-md-4">
                                    <label for="Type">distance</label>
                                    <input type="number" class="form-control" value="" id="distance" name="distance" placeholder="distance">
                                </div>

                                <div class="form-group col-12 col-md-4">
                                    <label for="date">Date de début de location</label>
                                    <input type="date" class="form-control" value="" id="date_debut" name="date_debut" placeholder="Date de début" >
                                </div>

                                <div class="form-group col-12 col-md-4">
                                    <label for="date">Date de fin de location</label>
                                    <input type="date" class="form-control" value="" id="date_fin" name="date_fin" placeholder="Date de fin de location" >
                                </div>
                                <div class="form-group col-12 col-md-4">
                                ...
                                <div class="form-group col-12 col-md-4">
                                    ...
                                    <input type="number" class="form-control" onclick="calculerPrixTotal()" value="" id="prix_location" name="montant" placeholder="prix de la location" readonly >
                                </div>
